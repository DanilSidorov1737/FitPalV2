...
$(document).ready(function(){
  $.ajax({
    ...
    success: function (data1) {
      ...
      x = Number(data1[0]['bench'])
      y = Number(data1[0]['squat'])
      z = Number(data1[0]['deadlift'])
      prs = x + y + z
      ...
      dataArr2 = [];
      const weight = data1[3]
      const myJSON = JSON.stringify(weight, null, 4);
      dataArr2 = JSON.parse(myJSON);
      weightChart()
